...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{tests/robot.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{tests/indexer.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{tests/searcher_results.png}}
\caption{Фрагмент результатов поиска по запросу "<unique ptr"> в Postman}
\label{tests/searcher_results.png:image}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{tests/searcher_logs.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{tests/logger.png}}
...
\begin{figure}[H]
\center{\includegraphics[width=1\linewidth]{tests/web.png}}
